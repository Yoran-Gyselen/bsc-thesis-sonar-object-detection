...
\title[Efficiënte classificatie met geavanceerde leertechnieken]%
    {Categoriseren van Objecten in Sonardata met behulp van Semi- of \\ Self-supervised Learning}
...
\input{data}
\input{implementatie}
\input{training-optimalisatie}
\input{evaluatie_modellen}
\input{evaluatie_resultaten}
